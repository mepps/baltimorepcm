...
?>
       <div class="<?php echo $onetone_animated; ?>" data-animationduration="0.9" data-animationtype="bounceInDown" data-imageanimation="no">
          ...
          <div style="margin-top: 50px; " class="section-subtitle <?php echo 'section_subtitle_'.$i;?>"><?php echo do_shortcode(wp_kses($section_subtitle, $allowedposttags));?></div>
          <div class="home-section-content">
          <div style="margin-top: 20px;">
            
            <?php if( $btn_text != ''):?>
            <a href="<?php echo esc_url($btn_link);?>" target="<?php echo esc_attr($btn_target);?>" class=" magee-btn-normal banner-scroll btn-lg btn-line btn-light <?php echo 'section_btn_text_'.$i; ?>" style="text-decoration: none;"><?php echo do_shortcode($btn_text);?></a> 
               <?php endif;?>
            </div>
           <?php 
		   $icon_items = '';
