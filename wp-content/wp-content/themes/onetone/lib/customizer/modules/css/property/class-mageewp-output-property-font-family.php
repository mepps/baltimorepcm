 ...
 * Output overrides.
 */
class Mageewp_Output_Property_Font_Family extends Mageewp_Output_Property {
	...
	protected function process_value() {
		...
		$google_fonts_array = Mageewp_Fonts::get_google_fonts();
		$backup_fonts       = Mageewp_Fonts::get_backup_fonts();
		...
		// Add backup font.
		if ( Mageewp_Fonts::is_google_font( $family ) ) {
