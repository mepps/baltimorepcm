 ...
 */
class Mageewp_Modules_Customizer_Branding {
	...
	public function customize_controls_print_scripts() {
		...
		if ( ! empty( $vars['logoImage'] ) || ! empty( $vars['description'] ) ) {
			wp_register_script( 'mageewp-branding', Mageewp::$url . '/modules/customizer-branding/branding.js' );
			wp_localize_script( 'mageewp-branding', 'hooBranding', $vars );
			wp_enqueue_script( 'mageewp-branding' );
		}
	}
}
