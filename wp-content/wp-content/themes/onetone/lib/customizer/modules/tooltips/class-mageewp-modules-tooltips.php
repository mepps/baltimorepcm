 ...
 */
class Mageewp_Modules_Tooltips {
	...
	public function customize_controls_print_footer_scripts() {
		...
		wp_enqueue_script( 'mageewp-tooltip', trailingslashit( Mageewp::$url ) . 'modules/tooltips/tooltip.js', array( 'jquery' ) );
		wp_localize_script( 'mageewp-tooltip', 'hooTooltips', $this->tooltips_content );
		wp_enqueue_style( 'mageewp-tooltip', trailingslashit( Mageewp::$url ) . 'modules/tooltips/tooltip.css', null );
