jQuery( document ).ready( function() {
	...
	wp.customize.section.each( function( section ) {
		...
		if ( sectionLi.hasClass( 'control-section-mageewp-expanded' ) ) {
...
( function() {
	...
	wp.customize.bind( 'pane-contents-reflowed', function() {
		...
		wp.customize.section.each( function( section ) {
			...
			if ( 'mageewp-nested' !== section.params.type || _.isUndefined( section.params.section ) ) {
				return;
			}
		...
		wp.customize.panel.each( function( panel ) {
			if ( 'mageewp-nested' !== panel.params.type || _.isUndefined( panel.params.panel ) ) {
				return;
			}
			panels.push( panel );
		});
	...
	wp.customize.Panel = wp.customize.Panel.extend({
		attachEvents: function() {
			...
			if ( 'mageewp-nested' !== this.params.type || _.isUndefined( this.params.panel ) ) {
		...
		isContextuallyActive: function() {
			...
			if ( 'mageewp-nested' !== this.params.type ) {
	...
	wp.customize.Section = wp.customize.Section.extend({
		attachEvents: function() {
			...
			if ( 'mageewp-nested' !== this.params.type || _.isUndefined( this.params.section ) ) {
