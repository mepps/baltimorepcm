 ...
 */
class Mageewp_Modules_Field_Dependencies {
	...
	public function field_dependencies() {
		...
		wp_enqueue_script( 'mageewp_field_dependencies', trailingslashit( Mageewp::$url ) . 'modules/field-dependencies/field-dependencies.js', array( 'jquery', 'customize-base', 'customize-controls' ), false, true );
		...
		wp_localize_script( 'mageewp_field_dependencies', 'fieldDependencies', $field_dependencies );
