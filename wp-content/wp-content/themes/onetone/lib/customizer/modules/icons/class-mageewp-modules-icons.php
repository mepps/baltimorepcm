...
class Mageewp_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		...
		$sections = Mageewp::$sections;
		$panels   = Mageewp::$panels;
		...
		wp_enqueue_script( 'mageewp_panel_and_section_icons', trailingslashit( Mageewp::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), false, true );
		wp_localize_script( 'mageewp_panel_and_section_icons', 'hooIcons', self::$icons );
