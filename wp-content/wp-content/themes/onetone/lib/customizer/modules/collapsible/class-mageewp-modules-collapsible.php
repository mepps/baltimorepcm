 ...
 */
class Mageewp_Modules_Collapsible {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'mageewp-collapsible', trailingslashit( Mageewp::$url ) . 'modules/collapsible/collapsible.js', array( 'customize-preview' ), false, true );
		wp_enqueue_style( 'mageewp-collapsible', trailingslashit( Mageewp::$url ) . 'modules/collapsible/collapsible.css' );
		...
		wp_localize_script( 'mageewp-collapsible', 'collapsible', $collapsible_fields );
