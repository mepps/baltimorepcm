 ...
 */
class Mageewp_Modules_Customizer_Styling {
	...
	public function custom_css() {
		...
		if ( $back ) {
			...
			$elements = array(
				'.customize-control-mageewp-background .background-attachment .buttonset .switch-label',
				'.customize-control-mageewp-background .background-size .buttonset .switch-label',
				'.customize-control-mageewp-radio-buttonset .buttonset .switch-label',
			);
			$css .= implode( ',', $elements ) . "{color:{$text_on_back};}";
			...
			$css .= ".customize-control-mageewp-slider input[type=range]::-webkit-slider-thumb{background-color:{$accent};}";
			$css .= ".customize-control-mageewp-slider input[type=range]::-moz-range-thumb{background-color:{$accent};}";
			$css .= ".customize-control-mageewp-slider input[type=range]::-ms-thumb{background-color:{$accent};}";

			$css .= ".customize-control-mageewp-slider input[type=range]{background:{$border_on_back};}";
			...
			$css .= ".mageewp-reset-section .dashicons{color:{$back_on_back};}";
		...
		if ( $accent ) {
			...
			$elements = array(
				'.customize-control-mageewp-radio-buttonset .buttonset .switch-input:checked + .switch-label',
				'.customize-control-mageewp-background .background-attachment .buttonset .switch-input:checked + .switch-label',
				'.customize-control-mageewp-background .background-size .buttonset .switch-input:checked + .switch-label',
			);
