 ...
 */
final class Mageewp_Modules_Webfonts_Link {
	...
	public function enqueue() {
		...
		if ( '' !== $this->link ) {
			wp_enqueue_style( 'mageewp_google_fonts', $this->link, array(), null );
		}
	}
	...
	public function create_link() {
		...
		if ( true === Mageewp_Fonts_Google::$force_load_all_subsets ) {
