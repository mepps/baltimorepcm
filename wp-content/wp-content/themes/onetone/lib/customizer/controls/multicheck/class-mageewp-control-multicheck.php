 ...
 */
class Mageewp_Control_MultiCheck extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'mageewp-multicheck';
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Mageewp_Custom_Build' ) || ! Mageewp_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'mageewp-multicheck', trailingslashit( Mageewp::$url ) . 'controls/multicheck/multicheck.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'mageewp-multicheck-css', trailingslashit( Mageewp::$url ) . 'controls/multicheck/multicheck.css', null );
		}
	}
