 ...
 */
class Mageewp_Control_Switch extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Mageewp_Custom_Build' ) || ! Mageewp_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'mageewp-switch', trailingslashit( Mageewp::$url ) . 'controls/switch/switch.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'mageewp-switch-css', trailingslashit( Mageewp::$url ) . 'controls/switch/switch.css', null );
		}
	}
