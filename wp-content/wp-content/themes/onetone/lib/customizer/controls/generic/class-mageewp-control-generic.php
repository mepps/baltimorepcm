 ...
 */
class Mageewp_Control_Generic extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Mageewp_Custom_Build' ) || ! Mageewp_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'mageewp-generic', trailingslashit( Mageewp::$url ) . 'controls/generic/generic.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'mageewp-generic-css', trailingslashit( Mageewp::$url ) . 'controls/generic/generic.css', null );
		}
	}
