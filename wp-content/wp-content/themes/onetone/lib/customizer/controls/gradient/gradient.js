wp.customize.controlConstructor['mageewp-gradient'] = wp.customize.Control.extend({
	...
	initMageewpControl: function() {
		...
		var control      = this,
		    ...
		    pickerStart  = control.container.find( '.mageewp-gradient-control-start' ),
		    pickerEnd    = control.container.find( '.mageewp-gradient-control-end' ),
