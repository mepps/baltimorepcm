 ...
 */
class Mageewp_Control_Radio_Buttonset extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'mageewp-radio-buttonset';
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Mageewp_Custom_Build' ) || ! Mageewp_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'mageewp-radio-buttonset', trailingslashit( Mageewp::$url ) . 'controls/radio-buttonset/radio-buttonset.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'mageewp-radio-buttonset-css', trailingslashit( Mageewp::$url ) . 'controls/radio-buttonset/radio-buttonset.css', null );
		}
	}
