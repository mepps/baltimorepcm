 ...
 */
class Mageewp_Control_Radio_Image extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'mageewp-radio-image';
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Mageewp_Custom_Build' ) || ! Mageewp_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'mageewp-radio-image', trailingslashit( Mageewp::$url ) . 'controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'mageewp-radio-image-css', trailingslashit( Mageewp::$url ) . 'controls/radio-image/radio-image.css', null );
		}
	}
