 ...
 */
class Mageewp_Control_Toggle extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Mageewp_Custom_Build' ) || ! Mageewp_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'mageewp-toggle', trailingslashit( Mageewp::$url ) . 'controls/toggle/toggle.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'mageewp-toggle-css', trailingslashit( Mageewp::$url ) . 'controls/toggle/toggle.css', null );
		}
	}
