...
/**
 * The Mageewp_Config object
 */
final class Mageewp_Config {
	 ...
	 * @access private
	 *
	 * @param string $config_id @see Mageewp_Config::get_instance().
	 * @param array  $args      @see Mageewp_Config::get_instance().
	 */
