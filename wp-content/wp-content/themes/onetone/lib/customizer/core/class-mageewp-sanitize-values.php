...
class Mageewp_Sanitize_Values {
	...
	public static function __callStatic( $name, $arguments ) {
		error_log( "Mageewp_Sanitize_Values::$name does not exist" );
		return $arguments;
	}
	 ...
	 *
	 * Deprecated. Use Mageewp_Field_Checkbox::sanitize() instead.
	 *
	 * @static
	 * @access public
	 * @see Mageewp_Field_Checkbox::sanitize()
	 * @param bool|string $value Whether the checkbox is checked.
	 * @return bool Whether the checkbox is checked.
	 */
	public static function checkbox( $value ) {
		$obj = new Mageewp_Field_Checkbox();
