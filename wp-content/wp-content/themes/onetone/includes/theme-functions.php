...
function onetone_theme_options(){
	...
	/*
	foreach ( $default_sections as $home_section ){
		$section_options[] = onetone_get_section_options($home_section['id'],$home_section['type']);
	}
	...
	//  Onetone: Slideshow
	$options[] = array(
		'slug'		=> 'onetone_slideshow',
		'label'		=> __( 'Onetone: Slideshow', 'onetone' ),
		'priority'	=> 1,
		'type' 		=> 'panel'
	);
	...
	// slider
	$options[] = array(
		'slug'		=> 'onetone_section_slider',
		'label'		=> __( 'Slider', 'onetone' ),
		'panel' 	=> 'onetone_slideshow',
		'priority'	=> 2,
		'type' 		=> 'section'
		);
   ...
   $options[] =  array(
       ...
       'description' => '',
       'type'        => 'repeater',
       'section'     => 'onetone_section_slider',   
	   'row_label' => array(
	   		'type' => 'text',
	...
	$options[] = array(
		...
		'label'		=> __( 'Slider Options', 'onetone' ),
		'panel' 	=> 'onetone_slideshow',
		'priority'	=> 3,
		'type' 		=> 'section'
		);
...
$options[] = array(
   ...
   // Logo Options
	...
	$options[] = array(
		...
		'label'		=> __( 'Page Title Bar Options', 'onetone' ),
		'panel' 	=> 'onetone_page_title_bar',
		'priority'	=> 1,
		'type' 		=> 'section'
		);
  ...
  $options[] = array(
		...
		'label'		=> __( 'Breadcrumb Options', 'onetone' ),
		'panel' 	=> 'onetone_page_title_bar',
		'priority'	=> 2,
		'type' 		=> 'section'
		);
